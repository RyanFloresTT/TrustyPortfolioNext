...
draft: false
summary: I go over my week 4-5 development on my first game!
---

After about a month of hard work and dedication, learning on weekdays, and applying that newfound knowledge to my game on the weekends, I am proud to announce that my game, Dimension Dissension, is complete!
...
Throughout this project, I also learned about Github projects and I used issue tracking and pull requests for the past 2 weeks. I would create a new branch to work on a new feature, and then commit that branch, close the issue and make a pull request to merge the changes into the main branch. in my next project, and for the rest of my game develoment career, I will be sure to continue to use Version Control, and learn more about Project Management. I used a Kanban board toward the end of this project, but I would like to use one from start to finish.
...
I will be announcing my next project soon. I am very excited to be working on it. I have a few friends who have both been very eager to work on games themselves, so this next project should be a little bit bigger in scope (maybe). One friend will be working on narrative design and doing some voice work, the other will be doing some animation rigging and level design, and I will assume the role of programmer and game design. Though we all have specific roles, we will all be talking to each other to bounce ideas off of one another. Stay tuned to hear more about that project!

‍

P.S. The name of the game now makes absolutely no sense, but I'm keeping it anyways ;)
